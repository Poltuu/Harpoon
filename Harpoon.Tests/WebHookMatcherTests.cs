...
namespace Harpoon.Tests
{
    public class WebHookMatcherTests
    {
        ...
        public static IEnumerable<object[]> MatchesScenario => new List<object[]>
        {
            ...
            new object[] { new List<WebHookFilter> { new WebHookFilter { Parameters = new Dictionary<string, object> { [""] = 2 } } }, new WebHookNotification { Payload = new List<int> { 1, 2, 3 } }, true }, //value found list
            new object[] { new List<WebHookFilter> { new WebHookFilter { Parameters = new Dictionary<string, object> { [""] = 2 } } }, new WebHookNotification { Payload = new [] { 1, 2, 3 } }, true }, //value found array
            new object[] { new List<WebHookFilter> { new WebHookFilter { Parameters = new Dictionary<string, object> { [""] = 20 } } }, new WebHookNotification { Payload = new List<int> { 1, 2, 3 } }, false }, //value not found
            new object[] { new List<WebHookFilter> { new WebHookFilter { Parameters = new Dictionary<string, object> { [""] = new List<int> { 1, 2, 3 } } } }, new WebHookNotification { Payload = new List<int> { 1, 2, 3 } }, true }, //sequence found
